...
namespace InterfacesLab
{
    ...
    public interface IInput
    {
        ...
        /// <returns>the string the user enters, or an empty string if the string did not match any of the allowable values</returns>
        ...
        /// <returns>the integer the user enters, or -1 if the user enters an invalid value</returns>
        ...
        /// <param name="lowerBound">the lower limit of allowable values, inclusive</param>
        /// <param name="upperBound">the upper limit of allowable values, inclusive</param>
        /// <returns>the double the user enters, or -1 if the user enters an invalid value</returns>
